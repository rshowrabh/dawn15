...
$('.readmore').click(function (event) {
  $(this).prev('.product-description-full').css("display","block");
  $(this).prev('.product-description-full').css("visibility","visible");
  $(this).prev('.product-description-short').css("display","none");
  });